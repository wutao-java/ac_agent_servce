"""第 17 课：配置与能力声明读取。课程代码从这里统一读取环境变量和 capabilities 文件。"""
...
PLACEHOLDER_API_KEYS = {"", "你的模型平台 Key", "your-api-key", "YOUR_API_KEY", "sk-your-openai-compatible-key", "your-api-key-here", "replace-me"}
